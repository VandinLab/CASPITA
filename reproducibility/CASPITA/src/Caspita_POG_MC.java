...
public class Caspita_POG_MC implements Serializable {
    ...
    Caspita_POG_MC(String fileIn, String fileOutOver, String fileOutUnder, JavaSparkContext scc) {
        this.fileIn = fileIn;
    ...
    void generateDatasetRandom(Random r, int h, int k) {
    ...
    public static void main(String[] args) {
        ...
        Path folder = Paths.get("res/POG_MC/");
        try {
            Files.createDirectories(folder);
        }
        catch (IOException e){
            System.out.println("Error Creating Folders \"res/POG_MC/\"!");
            System.exit(1);
        }
        for (int k = 2; k <= 5; k++) {
            for (int h = 1; h < k; h++) {
                System.out.println("k: " + k + " h: " + h);
                String fileOutOver = "res/POG_MC/" + dataset + "_POG_MC_" + P + "_" + M + "_" + k + "_" + h + "_OV.txt";
                String fileOutUnder = "res/POG_MC/" + dataset + "_POG_MC_" + P + "_" + M + "_" + k + "_" + h + "_UN.txt";
                long start = System.currentTimeMillis();
                ...
                Caspita_POG_MC caspita = new Caspita_POG_MC(fileIn, fileOutOver, fileOutUnder, scc);
